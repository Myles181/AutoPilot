...
export default function ProblemSolutionSection() {
    return (
        <section className="w-full max-w-[1200px] mx-auto px-6 py-24 font-sans text-white">
            <motion.div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <motion.div
                    ...
                    className="bg-[#111113] rounded-[2.5rem] p-12 lg:p-16 border border-white/5 flex flex-col justify-between group overflow-hidden relative min-h-[500px]"
                >
                ...
                <motion.div
                    ...
                    className="bg-gradient-to-br from-[#1a1a1f] to-[#0a0a0c] rounded-[2.5rem] p-12 lg:p-16 border border-white/10 flex flex-col justify-between group overflow-hidden relative min-h-[500px]"
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h4 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
                            An AI agent that <br /> works for you.
                        </h4>
