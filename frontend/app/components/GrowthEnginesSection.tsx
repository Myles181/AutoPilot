    ...
    return (
        <section className="w-full max-w-[1200px] mx-auto sm:px-6 py-16 md:py-24 font-sans text-white border-t border-white/10">
            ...
            <motion.div
                ...
                className="text-center mb-16 md:mb-24 max-w-3xl mx-auto px-6 sm:px-0"
            >
            ...
            <div className="space-y-0 sm:space-y-6">
                ...
                <motion.div
                    ...
                    className="bg-[#111113] rounded-none sm:rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-20 border-y sm:border border-white/5 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden group"
                >
                    ...
                    <div className="flex-1 w-full relative z-10 text-center md:text-left pt-4 md:pt-0">
                        <div className="text-sm font-bold tracking-widest text-emerald-500 uppercase mb-4">Lending Engine</div>
                        <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6 tracking-tight">Stable, <br className="hidden md:block" />low-risk yield.</h3>
                        <p className="text-lg md:text-xl text-gray-400 font-medium leading-relaxed mb-8 max-w-lg mx-auto md:mx-0">
                        ...
                        <div className="w-full aspect-square md:aspect-[4/3] bg-black rounded-3xl border border-white/10 p-8 flex flex-col justify-between shadow-2xl relative overflow-hidden">
                            ...
                            <div className="space-y-4 relative z-10">
                                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                                    <div className="text-[10px] md:text-xs text-gray-400 mb-1">Deposit Executed</div>
                                    <div className="text-lg md:text-xl font-bold text-white">+ 20.00 cUSD to Moola</div>
                                </div>
                                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10 ml-4 md:ml-8">
                                    <div className="text-[10px] md:text-xs text-gray-400 mb-1">Yield Earned (7 Days)</div>
                                    <div className="text-lg md:text-xl font-bold text-emerald-400">+ 1.40 cUSD</div>
                                </div>
                                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                                    <div className="text-[10px] md:text-xs text-gray-400 mb-1">Safety Floor Triggered</div>
                                    <div className="text-lg md:text-xl font-bold text-white">Auto-withdrawal generated</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true, margin: "-100px" }}
                    transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
                    className="bg-[#111113] rounded-none sm:rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-20 border-b sm:border border-white/5 flex flex-col md:flex-row-reverse items-center gap-12 relative overflow-hidden group"
                >
                    ...
                    <div className="flex-1 w-full relative z-10 text-center md:text-left pt-4 md:pt-0">
                        ...
                        <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-6 tracking-tight">Instant, <br className="hidden md:block" />profitable spreads.</h3>
                        <p className="text-lg md:text-xl text-gray-400 font-medium leading-relaxed mb-8 max-w-lg mx-auto md:mx-0">
                        ...
                        <div className="w-full aspect-square md:aspect-[4/3] bg-black rounded-3xl border border-white/10 p-8 flex flex-col justify-between shadow-2xl relative overflow-hidden">
                            ...
                            <div className="space-y-4 relative z-10">
                                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                                    <div className="text-base md:text-lg font-bold text-white">Ubeswap <span className="text-gray-500 text-xs md:text-sm font-medium mx-1 md:mx-2">0.992</span></div>
                                    <div className="text-[#FF5C38] font-bold text-xs md:text-base animate-pulse">+0.8% SPREAD</div>
                                </div>
                                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                                    <div className="text-base md:text-lg font-bold text-white">Mento <span className="text-gray-500 text-xs md:text-sm font-medium mx-1 md:mx-2">1.000</span></div>
                                </div>
                                <div className="mt-8 bg-[#FF5C38] rounded-2xl p-4 text-center">
                                    <div className="text-white font-bold text-sm md:text-lg">Execute Trade: +$0.04 Profit</div>
                                </div>
                            </div>
                        </div>
                    </div>
